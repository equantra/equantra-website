...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.jpg", width: 2738, height: 1664, alt: "Contact Equantra" }],
  },
  twitter: {
...
const breadcrumbJsonLd = {
  ...
  "@type": "BreadcrumbList",
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Home", item: "https://equantra.in" },
    { "@type": "ListItem", position: 2, name: "Contact", item: "https://equantra.in/contact" },
  ],
};
