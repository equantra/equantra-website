...
const Navbar = () => {
  ...
  return (
    <nav
      ...
      className={`z-40 sticky top-0 left-0 w-full px-4 md:px-6 py-4 transition-colors duration-300 ${isHovering || scrolling ? "bg-white backdrop-filter backdrop-blur-md bg-opacity-10" : "bg-transparent"
        }`}
    >
