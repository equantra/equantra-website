    ...
    <React.Fragment>
      <section className="z-4 h-[36rem] relative flex flex-col items-center justify-center px-4 md:px-6">   
        ...
        <div className="relative z-10 text-center space-y-10 max-w-xl mx-auto">
          <h1 className={`${montserrat.className} z-20 text-4xl lg:text-9xl md:text-6xl sm:text-5xl font-bold text-white tracking-tight`}>
            EQUANTRA
          </h1>
          <p className="text-sm lg:text-2xl md:text-2xl text-gray-300">
            Lorem ipsum dolor sit ametLorem ipsum dolor sit amet
          </p>
          <button className="mt-8 px-8 py-3 text-sm md:text-lg lg:text-xl rounded-full bg-white text-black font-medium hover:bg-gray-100 transition-colors inline-flex items-center">
            Get in touch →
          </button>
        </div>
